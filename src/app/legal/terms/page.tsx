  ...
  return (
    <div className="container mx-auto py-8">
      ...
      <div className="text-gray-700">
        ...
        <h2>Introduction</h2>
        <p>
          Welcome to Gramshop! These Terms of Service (&quot;Terms&quot;) govern
          your use of our website located at{" "}
          <a href="https://gramshop.co">https://gramshop.co</a>{" "}
          (&quot;Website&quot;), and any related services, features, content,
          apps, or applications offered by us (collectively, the
        ...
        <p>
          ...
          these Terms, you represent and warrant that you are at least 18 years
          old and have the legal capacity to enter into a binding contract.
        </p>

        <h2>Use of the Service</h2>
        <p>
          Gramshop grants you a limited, non-exclusive, non-transferable, and
          revocable license to use the Service subject to your compliance with
          these Terms. You agree not to use the Service in any manner that is
          illegal or not authorized by these Terms.
        </p>
        ...
        <p>
          ...
          software used on the Service, is the property of Gramshop or its
          licensors and protected by copyright and other laws that protect
        ...
        <p>
          ...
          &quot;scraping&quot;; using any automated system, including without
          limitation &quot;robots,&quot; &quot;spiders,&quot; &quot;offline
          readers,&quot; etc., to access the Service; attempting to interfere
        ...
        <p>
          ...
          <a href="mailto:culda@members.page">culda@members.page</a>.
        </p>
      </div>
    </div>
  );
