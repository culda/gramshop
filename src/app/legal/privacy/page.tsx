    ...
    <div className="container mx-auto py-8">
      ...
      <div className="text-gray-700">
        ...
        <p>
          ...
          your data when you visit our website [Your Website URL].
        </p>
        ...
        <p>
          Gramshop may collect and use Users&apos; personal information for the
          following purposes:
        </p>
        <ul>
        ...
        <p>
          Gramshop has the discretion to update this privacy policy at any time.
          When we do, we will post a notification on the main page of our Site
          and revise the updated date at the top of this page.
        </p>
